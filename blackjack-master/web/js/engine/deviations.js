...
export function findDeviation(playerValues, dealerUp) {
    ...
    return DEVIATIONS.find((d) => {
        ...
        if (isPairDev !== isPairHand)
            return false;
        if (isPairDev)
            return playerValues[0] === d.playerValues[0];
...
export function deviationsApplicable(rules) {
    return rules.decks >= 4;
}
export const DEVIATIONS_NOTE_HE = 'מספרי האינדקס לקוחים מרשימת Illustrious 18 ו-Fab 4 המתועדות (Don Schlesinger), והם מחושבים עבור נעל של 4-8 חפיסות בשיטת Hi-Lo. במשחק של חפיסה אחת או שתיים האינדקסים שונים ולכן אינם מוצגים כאן כאמת.';
//# sourceMappingURL=deviations.js.map