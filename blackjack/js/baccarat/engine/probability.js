 ...
 */
import { bankerDraws, playerDraws } from "./thirdCard.js";
/** הרכב נעל לפי ערכי באקרה: אינדקס 0 = קלפי עשר, 1..9 = ערך הקלף. */
export function baccaratComposition(decks) {
...
export function exactProbabilities(decks) {
    ...
    let pBankerSix = 0;
    let cardsWeighted = 0;
    const record = (weight, playerTotal, bankerTotal, cards, natural) => {
