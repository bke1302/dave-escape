...
export function bottomNav(activePath) {
    ...
    return h('nav', { class: 'bottom-nav', attrs: { 'aria-label': 'ניווט ראשי' } }, ...items.map((item) => h('button', {
